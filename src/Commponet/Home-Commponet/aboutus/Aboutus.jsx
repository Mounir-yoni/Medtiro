...
import imagedoctor2 from '../../../image/doctor2.jpg'
import imagedoctor3 from '../../../image/doctor3.jpg'
import imagedoctor4 from '../../../image/doctor4.jpg'
...
export default function Aboutus() {
  return (
    <div className='mt-5 container d-flex mb-5  aboutus-div' style={{position: 'relative'}}>
        <Col className='div-about-text ' xs={6} md={6} >
            ...
            <p>We provide the special tips and advice’s of heath care treatment and high level of best technology involve in the our hospital.</p>
              ...
              <div className="row-about-us " style={{width:'100%'}}>
                  ...
                  <div className="feature-container feature-bx1 feature1">
                    <div className="icon-md">
                      <span className="icon-cell">
                        <svg style={{background:"new 0 0 512 512"}}  height="50" viewBox="0 0 512 512" width="55" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </path><path d="m183.629 66.808c5.522 0 10-4.477 10-10v-12.104c0-5.523-4.478-10-10-10s-10 4.477-10 10v12.104c0 5.523 4.477 10 10 10z"></path><path d="m236.764 94.969c1.934 1.829 4.404 2.736 6.871 2.736 2.652 0 5.299-1.048 7.266-3.127l10.626-11.229c3.796-4.011 3.621-10.341-.391-14.137s-10.341-3.621-14.137.391l-10.626 11.229c-3.796 4.012-3.621 10.341.391 14.137z"></path><path d="m116.358 94.579c1.967 2.078 4.613 3.126 7.266 3.126 2.467 0 4.938-.907 6.871-2.737 4.012-3.796 4.187-10.125.391-14.137l-10.627-11.229c-3.796-4.011-10.126-4.187-14.137-.39-4.012 3.796-4.187 10.125-.391 14.137z"></path><path d="m90.896 216.592h184.372v113.287h-184.372z" fill="#b2f0fb"></path>
                        </svg>
                      </span>
                    </div>
                          ...
                          <div className="icon-md">
                            <span className="icon-cell">
                              <svg style={{background:"new 0 0 512 512"}} height="50" viewBox="0 0 512 512" width="55" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="m279.576 280.012v-29.712c0-5.523-4.478-10-10-10h-46.783c-5.522 0-10 4.477-10 10v29.712h-29.711c-5.522 0-10 4.477-10 10v46.783c0 5.523 4.478 10 10 10h29.711v29.711c0 5.523 4.478 10 10 10h46.783c5.522 0 10-4.477 10-10v-29.711h29.712c5.522 0 10-4.477 10-10v-46.783c0-5.523-4.478-10-10-10zm19.712 46.783h-29.712c-5.522 0-10 4.477-10 10v29.711h-26.783v-29.711c0-5.523-4.478-10-10-10h-29.711v-26.783h29.711c5.522 0 10-4.477 10-10v-29.712h26.783v29.712c0 5.523 4.478 10 10 10h29.712z"></path><path d="m369.497 246.666c51.239-.708 92.983-42.352 93.459-93.223.313-33.486-16.989-62.983-43.266-79.911-21.598-13.914-37.772-29.46-45.4-53.873l-6.143-19.659-6.143 19.661c-7.603 24.331-23.627 39.927-45.19 53.738-26.16 16.756-43.48 45.945-43.48 79.151 0 52.43 43.18 94.848 96.163 94.116z" fill="#ffbdbc">
                                </path>
                              </svg>
                           </span>
                          </div>
        ...
        <button className='btn-readmore-about-us'>Read More</button>


        
        </Col>
        <Col className='div-about-image'  xs={6} md={6} >
        
            <div className='div-doctors-image-about-us'>
            <img src={imagedoctor3} className="img-doctor4" alt="" />
            <img src={imagedoctor2} className="img-doctor3" alt="" />
            <img src={imagedoctor4} className="img-doctor5" alt="" />
            <div className="pointofexperience"></div>
            <div className="experience-card">
                <h2 className="experience-number">20</h2>
                <p className="experience-text">Year Experience</p>
            </div>

            </div>
        </Col>
        <div className='div-about-background-image'>
              <img src={imagebox} alt="" className='img-about-background-box displayback' />
              <img src={imagebox} alt="" className='img-about-background-box-2 displayback' />
              <img src={imageboxorange}  className='img-about-background-box-3 displayback' alt="" />
        </div>
    </div>
  )
}
